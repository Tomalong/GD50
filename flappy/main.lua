...
function love.update(dt)
    ...
    backgroundScroll = (backgroundScroll + BACKGROUND_SCROLL_SPEED * dtProxy) % BACKGROUND_LOOPING_POINT
    groundScroll = (groundScroll + GROUND_SCROLL_SPEED * dtProxy) % VIRTUAL_WIDTH
